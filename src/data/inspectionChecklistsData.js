    ...
    sections: [
      {
        ...
        items: [
          sw('con001', 'Verify contractor holds a valid contractor license in your state (check your state licensing board website)',
            'Most states require contractors doing work above a certain dollar threshold to hold a valid license through a state licensing board. An unlicensed contractor cannot legally pull permits in their name, has no accountability to a licensing board, and leaves you with no recourse if work fails inspection or the project is abandoned.'),
          s('con002', 'Confirm license is in good standing — no suspensions or disciplinary actions'),
          s('con003', 'Verify the business entity exists and is in good standing with your state\'s Secretary of State'),
          s('con004', 'Confirm they have a physical business address (not just a P.O. box or cell number)'),
          sw('con005', 'Check for any liens, judgments, or lawsuits filed against them in your county court records',
    ...
    sections: [
      {
        ...
        items: [
          ...
          s('ins003', 'Attic insulation depth meets required R-value for your climate zone (check IECC climate zone map)'),
