  ...
  return (
    <div className="mb-4">
      <button
        ...
        className="w-full flex items-center gap-2 bg-white border border-linen rounded-xl px-3 py-2 text-left hover:bg-cream/50 transition-colors"
      >
        ...
        <span className="text-[11px] text-mist font-medium bg-linen/70 px-2 py-0.5 rounded-full shrink-0">
      ...
      {open && (
        <div className="mt-1 bg-white border border-linen rounded-xl shadow-md overflow-hidden">
          {others.map((t) => (
            <a
              key={t.token}
              href={`/t/${t.token}`}
              className="flex items-center gap-3 px-3 py-2.5 hover:bg-cream/50 transition-colors border-b border-linen/50 last:border-b-0"
            >
          ...
          <a
            href="/portal"
            className="flex items-center gap-3 px-3 py-2.5 hover:bg-cream/50 transition-colors text-forest"
          >
            <div className="w-8 h-8 rounded-lg bg-forest/10 flex items-center justify-center shrink-0">
              <LayoutGrid size={14} className="text-forest" />
            </div>
